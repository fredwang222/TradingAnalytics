"""
Template for implementing QLearner  (c) 2015 Tucker Balch    modified by Yuzhou Li
"""
...
class QLearner(object):
    ...
    def __init__(self, \
        ...
        self.T = np.array([0]*num_states*num_actions*num_states).reshape(num_states,num_actions,num_states)
        self.Tc = np.array([0.00001]*num_states*num_actions*num_states).reshape(num_states,num_actions,num_states)
        self.R = np.array([-0.000001]*num_states*num_actions).reshape(num_states,num_actions)
